...
draw_sprite_ext(spr_settings, keyboard_check(92), settingsx * ratio, settingsy * ratioVertical, button_scale * 0.5 * ratio, button_scale * 0.5 * ratioVertical, 0, c_white, controls_opacity);
