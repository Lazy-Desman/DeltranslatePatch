...
function scr_letter_fix(letter) {
	// LayeredFS on Switch doesn't like UTF-8 for filenames...
	var codepoint = ord(letter);
	// ASCII range, use as-is:
    if (codepoint < 128) return letter;
	// UTF-8 range, return a string of the decimal value instead
