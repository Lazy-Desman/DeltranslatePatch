...
border_options = ["Dynamic", "Simple", "None", "Wide"];
var border_options_en = ["Dynamic", "Simple", "None", "Wide"];
border_options_tr = [
    ...
    scr_84_get_lang_string("obj_darkcontroller_slash_Create_0_gml_5_0", "Wide")
];
var border_options_ja = ["ダイナミック", "シンプル", "なし", "ワイド"];
