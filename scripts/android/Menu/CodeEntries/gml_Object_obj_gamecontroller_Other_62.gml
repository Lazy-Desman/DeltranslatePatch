...
if (ds_map_find_value(async_load, "id") == lang_changes_call)
{
    if (ds_map_find_value(async_load, "status") == 0)
    {
        ...
        array_sort(versions, function(arg0, arg1)
        {
            return is_version_greater(string_to_version(arg1), string_to_version(arg0)) - is_version_greater(string_to_version(arg0), string_to_version(arg1));
        });
